<template>
  <div>
    ...
    <el-form-item label="最大行数（为0则不限制）">
      <el-input-number controls-position="right" :precision="0" :max="100" :min="0" size="small" v-model="value.maxSize"  placeholder="限制条数"/>
    </el-form-item>
    <el-form-item label="布局方式">
      <el-radio name="layout" :label="true" v-model="value.rowLayout">表格布局</el-radio>
      <el-radio name="layout" :label="false" v-model="value.rowLayout">表单布局</el-radio>
    </el-form-item>
